 ...
 * 浙江 AES加密工具
 */
public class OutProDockingAesUtil {
    ...
    //偏移量
    public static final String VIPARA = "255B675CDF21B04F";   //AES 为16bytes. DES 为8bytes
    //编码方式
    ...
    //私钥
    private static final String AES_KEY = "255B675CDF21B04F923992E0E9F4A498";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
